...
<body>
    ...
    <div id="Container">
        <br>
        <h1><span id="titulo" class="badge bg-light text-dark">Cadastrar Fabricação</span></h1>

        <form id="dados">
            <div class="mb-3">
                <input style="border-radius: 30px 30px 30px 30px" type="email" class="form-control" id="exampleFormControlInput1" placeholder="Ano">
            </div>
        </form>
