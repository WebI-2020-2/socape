    ...
    <div id="containerlimitado">
        ...
        <form id="form" action="" method="POST">
            <div class="mb-3">
                ...
                <input style="width: 130%" type="text" name="ano" oninput="validaInputNumber(this)" maxlength="4" class="form-control" placeholder="ANO DE FABRICAÇÃO" autocomplete="off" required>
            </div>
