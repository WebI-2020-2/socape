...
<body>
    ...
    <div id="Container">
        <br>
        <h1><span id="titulo" class="badge bg-light text-dark">Itens Venda</span></h1>
        <form id="dados">
            <div class="form-group">
                <select style="border-radius: 30px 30px 30px 30px" class="form-control" id="exampleFormControlSelect1">
